(() => {
  ...
  const messages = {
    en: {
      ...
      "history.search_aria": "Search translation history",
      ...
      "history.storage_error": "Translation complete · encrypted history could not be saved",
      ...
      "output.previous_preserved": "Previous result kept; it does not match the current source or settings",
      "output.discard_unsaved_confirm": "This result is not saved in the encrypted vault. Discard it?",
      "output.announce.loading": "Translation started.",
      "output.announce.complete": "Translation complete. The result is ready.",
      "output.announce.failed": "Translation failed: {message}",
      ...
      "translate.model_unavailable": "This model is not installed or configured yet.",
      ...
      "privacy.badge.loading": "Checking…",
      "privacy.badge.device": "This PC",
      "privacy.badge.private_network": "Private LAN",
      "privacy.private_network_confirm": "This model sends the text to the configured device on your private network (LAN). Continue?",
      ...
      "memory.discard_confirm": "Discard the unsaved changes to this translation asset?",
      ...
      "model.setup_required": "Setup required",
      ...
      "error.session_required": "This browser session is not authorized. Open the app again from Private Translator.",
      "error.origin_rejected": "The request did not come from the authorized local app page.",
    ...
    ko: {
      ...
      "history.storage_error": "번역 완료 · 암호화 기록 저장 실패",
      ...
      "output.previous_preserved": "이전 결과를 보존했습니다. 현재 원문 또는 설정의 번역 결과는 아닙니다",
      "output.discard_unsaved_confirm": "이 결과는 암호화 금고에 저장되지 않았습니다. 버릴까요?",
      "output.announce.loading": "번역을 시작했습니다.",
      "output.announce.complete": "번역이 완료되어 결과가 준비되었습니다.",
      "output.announce.failed": "번역에 실패했습니다: {message}",
      "translate.button": "번역하기",
      "translate.loading": "번역 중…",
      "translate.empty": "번역할 내용을 입력하세요.",
      "translate.not_ready": "로컬 번역 서비스가 아직 준비되지 않았습니다.",
      "translate.model_unavailable": "이 모델은 아직 설치 또는 설정되지 않았습니다.",
      ...
      "privacy.badge.loading": "확인 중",
      "privacy.badge.device": "이 PC",
      "privacy.badge.private_network": "개인 LAN",
      "privacy.private_network_confirm": "이 모델은 번역문을 설정된 개인 네트워크(LAN) 장치로 전송합니다. 계속할까요?",
      ...
      "memory.discard_confirm": "이 번역 자산의 저장하지 않은 수정 내용을 버릴까요?",
      ...
      "error.session_required": "이 브라우저 세션은 인증되지 않았습니다. Private Translator에서 앱을 다시 여세요.",
      "error.origin_rejected": "인증된 로컬 앱 화면에서 보낸 요청이 아닙니다.",
